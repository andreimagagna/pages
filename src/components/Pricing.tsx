...
// Placeholder para i18n – substitua pela sua implementação real
const t = (key: string) => key; // Ex: useTranslation().t
const i18n = { language: 'pt' }; // Ex: useTranslation().i18n

// Placeholder para dados – substitua pelos dados reais
const plans = [
  { id: 'price_1', name: 'Plano Básico', price: 10, currency: 'BRL' },
  // Adicione mais planos conforme necessário
];
const currencySymbol = 'R$'; // Ajuste baseado na moeda
